...
class FriendsCardWidget extends StatefulWidget {
  final String name;
  final String userid;
  ...
  @override
  _FriendsCardWidgetState createState() => _FriendsCardWidgetState();
}

class _FriendsCardWidgetState extends State<FriendsCardWidget> {
